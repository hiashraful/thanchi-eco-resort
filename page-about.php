...
<section class="py-24 bg-[#f2f1ef] dark:bg-[#25211c]">
    <div class="max-w-7xl mx-auto px-6 lg:px-12">
        <div class="text-center mb-16">
            ...
            <p class="text-[#6b635b] dark:text-[#a9a29a]"><?php esc_html_e('No corporate team. No management hierarchy. Just three friends who love these hills.', 'thanchi-eco-resort'); ?></p>
        </div>
    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-12">
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
            <div class="p-8 bg-white dark:bg-[#25211c] border border-[#e3e0de] dark:border-[#3a342e] rounded-2xl text-center">
                ...
                <p class="text-sm text-[#6b635b] dark:text-[#a9a29a]"><?php esc_html_e('We use solar power. We collect rainwater. We compost waste. The hills gave us everything - we try to give back.', 'thanchi-eco-resort'); ?></p>
            </div>
            ...
            <div class="p-8 bg-white dark:bg-[#25211c] border border-[#e3e0de] dark:border-[#3a342e] rounded-2xl text-center">
                ...
                <p class="text-sm text-[#6b635b] dark:text-[#a9a29a]"><?php esc_html_e('All our staff are from Thanchi. We buy from local farmers. Every rupee you spend here stays in this community.', 'thanchi-eco-resort'); ?></p>
            </div>
            ...
            <div class="p-8 bg-white dark:bg-[#25211c] border border-[#e3e0de] dark:border-[#3a342e] rounded-2xl text-center">
                ...
                <p class="text-sm text-[#6b635b] dark:text-[#a9a29a]"><?php esc_html_e('We could add more. Install AC. Get generators. But then this would become just another resort. We choose to stay simple.', 'thanchi-eco-resort'); ?></p>
            </div>
            ...
            <div class="p-8 bg-white dark:bg-[#25211c] border border-[#e3e0de] dark:border-[#3a342e] rounded-2xl text-center">
                ...
                <p class="text-sm text-[#6b635b] dark:text-[#a9a29a]"><?php esc_html_e('We tell you exactly what we have and what we do not. No surprises. No disappointments. Just reality, beautiful as it is.', 'thanchi-eco-resort'); ?></p>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="max-w-3xl mx-auto px-6 lg:px-12">
        ...
        <div class="space-y-6">
            <div class="bg-white dark:bg-background-dark p-6 rounded-xl border-l-4 border-primary">
                ...
                <p class="text-sm text-[#6b635b] dark:text-[#a9a29a]"><?php esc_html_e('Three friends start construction with bamboo, wood, and a dream. First structure completed in 6 months.', 'thanchi-eco-resort'); ?></p>
            </div>
            ...
            <div class="bg-white dark:bg-background-dark p-6 rounded-xl border-l-4 border-primary">
                ...
                <p class="text-sm text-[#6b635b] dark:text-[#a9a29a]"><?php esc_html_e('Despite the pandemic, our first guests arrived - a group of photographers looking for untouched nature. They stayed for two weeks.', 'thanchi-eco-resort'); ?></p>
            </div>
            ...
            <div class="bg-white dark:bg-background-dark p-6 rounded-xl border-l-4 border-primary">
                ...
                <p class="text-sm text-[#6b635b] dark:text-[#a9a29a]"><?php esc_html_e('Added two more rooms and started our restaurant. Shoriful officially became our full-time cook.', 'thanchi-eco-resort'); ?></p>
            </div>
            ...
            <div class="bg-white dark:bg-background-dark p-6 rounded-xl border-l-4 border-primary">
                ...
                <p class="text-sm text-[#6b635b] dark:text-[#a9a29a]"><?php esc_html_e('Featured in travel blogs. International guests start arriving. Still no WiFi. Still no AC. Still honest.', 'thanchi-eco-resort'); ?></p>
            </div>
            ...
            <div class="bg-white dark:bg-background-dark p-6 rounded-xl border-l-4 border-green-600">
                ...
                <p class="text-sm text-[#6b635b] dark:text-[#a9a29a]"><?php esc_html_e('Come be part of our story. Every guest who leaves renewed adds to what this place means.', 'thanchi-eco-resort'); ?></p>
            </div>
        </div>

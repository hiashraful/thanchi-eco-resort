...
<!-- Archive Posts -->
<section class="py-24 bg-background-light dark:bg-background-dark" aria-label="<?php esc_attr_e('Archive Posts', 'thanchi-eco-resort'); ?>">
    <div class="max-w-7xl mx-auto px-6 lg:px-12">
        ...
        <?php if (have_posts()) : ?>
            ...
            if ($pagination) :
            ?>
                <nav class="mt-16 flex justify-center gap-2" role="navigation" aria-label="<?php esc_attr_e('Archive Pagination', 'thanchi-eco-resort'); ?>">
